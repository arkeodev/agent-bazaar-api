...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('tier_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tier_id"], ["tier.id"], name="rate_limit_tier_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.INTEGER(), autoincrement=True, nullable=False),
        sa.Column(
            "created_by_user_id", sa.INTEGER(), autoincrement=False, nullable=False
        ),
        ...
        sa.Column("is_deleted", sa.BOOLEAN(), autoincrement=False, nullable=False),
        sa.ForeignKeyConstraint(
            ["created_by_user_id"], ["user.id"], name="post_created_by_user_id_fkey"
        ),
